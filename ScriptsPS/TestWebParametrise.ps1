...
#LB and VMs for first location
$loc1 = "North Europe"
$LBName1 = $RGName + "-LB1"

#LB and VMs for second location
$loc2 = "East Asia"
$LBName2 = $RGName + "-LB2"
...
Import-AzureRmAutomationDscConfiguration -SourcePath "d:\ScriptsPS\DSC\TestDocsAzureAutomation\TestConfig.ps1" -ResourceGroupName Test -AutomationAccountName "TestAA" -Description `
...
$Server1 = Get-AzureRmVM -ResourceGroupName TestWeb -Name Server1
Register-AzureRmAutomationDscNode -ResourceGroupName TestWeb -AzureVMName Server1 -AutomationAccountName TestWeb-AutoAcc -NodeConfigurationName "TestWeb-WebServer" -ConfigurationMode ApplyAndMonitor `
-AzureVMResourceGroup TestWeb -AzureVMLocation "North Europe"

Get-AzureRmAutomationDscNode -ResourceGroupName TestWeb -AutomationAccountName TestWeb-AutoAcc


$AutoAcct = Get-AzureRmAutomationAccount -ResourceGroupName Test -Name TestAA
...
Register-AzureRmAutomationDscNode -AzureVMName $VM.Name -AzureVMResourceGroup $VM.ResourceGroupName -AzureVMLocation $VM.Location -AutomationAccountName $AutoAcct.AutomationAccountName `
 -ResourceGroupName $AutoAcct.ResourceGroupName @DSCLCMConfig

#Remove-AzureRmResourceGroup -Name "TestWeb"
#Get-AzureRmResource | where {$_.Name -like "*IIs*"} | Remove-AzureRmResource -Force
